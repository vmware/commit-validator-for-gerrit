...
public class Constants {
    ...
    public static final String CONFIG_TEMPLATE_ENTRY_KIND = "kind";
    ...
    // Message Constants
    public static final String MESSAGE_VALIDATION_EXCEPTION = "Either missing or invalid commit template values";
